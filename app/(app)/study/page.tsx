...
const StudyResources: React.FC = () => {
  ...
  const handleUploadSubmit = async (uploadData: UploadData) => {
    try {
      ...
      if (profileError || !profile?.department_id || !profile?.institution_id) {
      ...
      // Create resource record via bridge
